...
//		DataScope_Get_Channel_Data( 0 , 10);
		...
		usart1_send(stringNum[0]);
		usart1_send(stringNum[1]);
		usart1_send(stringNum[2]);
		usart1_send(stringNum[3]);
		usart1_send(stringNum[4]);
//		usart1_send(' ');
//		for( i = 0 ; i < Send_Count; i++) 
//		{
//			usart1_send(DataScope_OutPut_Buffer[i]);
