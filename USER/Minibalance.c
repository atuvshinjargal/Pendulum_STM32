...
float Balance_KP=50,Balance_KD=244,Position_KP=25,Position_KD=600;  //PID coefficient
float Menu=1,Amplitude1=1,Amplitude2=10,Amplitude3=1,Amplitude4=10; //PID debugging related parameters
int main(void)
{ 
	...
	uart_init(72,115200);           //=====Initializing serial port 1
